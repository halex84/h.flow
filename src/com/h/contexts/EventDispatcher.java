 ...
 */
public class EventDispatcher implements DomainEventDispatcher {
    ...
    public static DomainEventDispatcher getInstance(){
        ...
        try{
            if (instance == null){
                ...
                instance = new EventDispatcher(LogFactory.makeLogger(), observers);
            }
            return instance;
        }
        finally {
    ...
    private EventDispatcher(Logger log, EventObserver[] observers){
        this.log = log;
